...
exports.BudgetInitService = void 0;
...
let BudgetInitService = class BudgetInitService {
    constructor(db, budgetResetService) {
        this.db = db;
...
exports.BudgetInitService = BudgetInitService;
exports.BudgetInitService = BudgetInitService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(drizzle_provider_1.DrizzleAsyncProvider)),
    __param(1, (0, common_1.Inject)(budget_reset_service_1.BudgetResetService)),
    __metadata("design:paramtypes", [node_postgres_1.NodePgDatabase,
        budget_reset_service_1.BudgetResetService])
], BudgetInitService);
//# sourceMappingURL=budget-init.service.js.map